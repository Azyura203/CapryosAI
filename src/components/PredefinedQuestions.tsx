      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {questions.map(({ text, icon: Icon, gradient, category }, index) => (
          <button
            ...
            className="group relative p-6 bg-gradient-to-br from-slate-700/50 to-purple-700/50 hover:from-slate-600/60 hover:to-purple-600/60 backdrop-blur-sm rounded-2xl border border-purple-500/30 hover:border-purple-400/50 transition-all duration-300 text-left overflow-hidden transform hover:scale-105 animate-fade-in"
          ...
          >
            ...
            <div className="relative flex flex-col gap-4">
              <div className="flex items-start justify-between">
                ...
                <div className="text-xs text-purple-300 bg-purple-600/50 px-2 py-1 rounded-full">
                  {category}
                </div>
              </div>
              
              <div className="space-y-2">
                <p className="text-purple-100 group-hover:text-white transition-colors duration-200 leading-relaxed font-medium">
                  {text}
                </p>
              </div>
            </div>
